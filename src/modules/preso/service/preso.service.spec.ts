...
//       providers: [
//         presoService,
//         { provide: getRepositoryToken(preso), useValue: mockRepository },
//       ],
//     }).compile();
...
//       const savedpreso = await service.create(preso);

//       expect(savedpreso).toMatchObject(mockRegistry);
//       expect(mockRepository.create).toBeCalledWith(preso);
...
//     it('should list all preso', async () => {
//       mockRepository.find.mockReturnValue([mockRegistry]);

//       const preso = await service.findAll();
...
//   // describe('when search one preso', () => {
//   //   it('should list one preso', async () => {
//   //     mockRepository.create.mockReturnValueOnce(mockRegistry);
//   //     mockRepository.save.mockReturnValueOnce(mockRegistry);

//   //     const presoUpdate: UpdatepresoDto = mockRegistry;
//   //     const preso = await service.search(presoUpdate);
...
//     it('should find a existing preso', async () => {
//       mockRepository.findOne.mockReturnValue(mockRegistry);

//       const preso = await service.findById('1');
...
//     it('should return a exception when does not to find a preso', async () => {
...
//       const updatedpreso = await service.update(
//         '1',
//         presoUpdate,
//       );
