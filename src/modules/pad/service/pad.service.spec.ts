...
//       providers: [
//         padService,
//         { provide: getRepositoryToken(pad), useValue: mockRepository },
//       ],
//     }).compile();
...
//       const savedpad = await service.create(pad);

//       expect(savedpad).toMatchObject(mockRegistry);
//       expect(mockRepository.create).toBeCalledWith(pad);
...
//     it('should list all pad', async () => {
//       mockRepository.find.mockReturnValue([mockRegistry]);

//       const pad = await service.findAll();
...
//   // describe('when search one pad', () => {
//   //   it('should list one pad', async () => {
//   //     mockRepository.create.mockReturnValueOnce(mockRegistry);
//   //     mockRepository.save.mockReturnValueOnce(mockRegistry);

//   //     const padUpdate: UpdatepadDto = mockRegistry;
//   //     const pad = await service.search(padUpdate);
...
//     it('should find a existing pad', async () => {
//       mockRepository.findOne.mockReturnValue(mockRegistry);

//       const pad = await service.findById('1');
...
//     it('should return a exception when does not to find a pad', async () => {
...
//       const updatedpad = await service.update(
//         '1',
//         padUpdate,
//       );
