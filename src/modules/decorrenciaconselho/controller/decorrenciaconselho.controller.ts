...
export class DecorrenciaConselhoController {
  ...
  @ApiOkResponse({
    type: [CreateDecorrenciaConselhoDto],
    description: 'The found DecorrenciaConselho',
  })
  ...
  @ApiCreatedResponse({
    type: UpdateDecorrenciaConselhoDto,
    description: 'Searched DecorrenciaConselho',
  })
  @ApiBadRequestResponse({ type: ErrorResponse, description: 'Bad Request' })
  async search(
    @Body() data: CreateDecorrenciaConselhoDto,
  ...
  @ApiCreatedResponse({
    type: UpdateDecorrenciaConselhoDto,
    description: 'Created DecorrenciaConselho',
  })
  @ApiBadRequestResponse({ type: ErrorResponse, description: 'Bad Request' })
  async create(
    @Body() data: CreateDecorrenciaConselhoDto,
  ...
  @ApiOkResponse({
    type: UpdateDecorrenciaConselhoDto,
    description: 'Updated DecorrenciaConselho',
  })
  @ApiNotFoundResponse({ type: ErrorResponse, description: 'Not Found' })
  async update(
    @Param('id') id: string,
