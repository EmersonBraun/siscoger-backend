...
//   async search(data: CreateDecorrenciaConselhoDto): Promise<DecorrenciaConselho[]> {
//     console.log(data)
//     return await this.repository.find({ where: { ...data } });
//   }

//   async create(data: CreateDecorrenciaConselhoDto): Promise<DecorrenciaConselho> {
...
//   async update(id: string, data: UpdateDecorrenciaConselhoDto): Promise<DecorrenciaConselho> {
